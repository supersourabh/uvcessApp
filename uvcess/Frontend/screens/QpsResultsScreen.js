...
import { Box, FlatList, Center, Stack, HStack, Text, Select, CheckIcon, Button, Spinner, Alert } from "native-base"
    ...
    return (
        <>
            ...
            <Select
                ...
                placeholder="select sem (default is 1)"
            ...
            >
                <Select.Item label="Question-Paper" value="Question-Paper" />
                <Select.Item label="Results" value="Results" />
